...
const projects = [
  ...
  {
    title: 'Restaurant Hari Prasad',
    location: 'Tirunelveli',
    division: 'commercial',
    description: 'A premium dining venue and commercial complex featuring bespoke interior wood carvings, decorative backlit false ceilings, modern marble-floored dining halls, and multi-specialty clinical spaces.',
    image: '/gallery/hari-prasath-3.jpg',
    status: 'Completed',
    meta: [
      { label: 'Project type', value: 'Commercial Complex / Restaurant' },
      { label: 'Client', value: 'Hari Prasad Group' },
      { label: 'Location', value: 'Tirunelveli, Tamil Nadu' },
      { label: 'Status', value: 'Completed' },
    ],
    details: [
      'Multi-level commercial facade with custom structural columns, warm timber trims, and ramp entryways',
      'Premium main dining hall with dynamic circular backlit false ceiling panels and modern light fixtures',
      'Secondary dining area featuring custom circular perforated wood ceiling designs and textured accent panels',
      'Bespoke solid wood bench seating and custom marble dining tables',
      'Integration of Dr. Rajas Dental Care hospital block on the upper levels',
      'Premium marble flooring, glass panel partitioning, and integrated HVAC systems',
    ],
    scope: [
      'Turnkey civil and structural commercial construction',
      'Custom interior architecture, ceiling design, and lighting execution',
      'Bespoke furniture fabrication and commercial fit-outs',
    ],
    gallery: [
      '/gallery/hari-prasath-3.jpg',
      '/gallery/hari-prasath-1.jpg',
      '/gallery/hari-prasath-2.jpg',
      '/gallery/hari-prasath-4.jpg',
    ],
  },
  {
    title: 'Nolabur Villa',
